...
import GetSourceId from "../../main/services/GetSourceId";
        ...
        it("Tests a successful send.", function () {
            ...
            return GetSourceId(undefined)(mockRequest, mockResponse as any)
                .then(function (res: Express.Response) {
                    ...
                    expect(mockResponse.statusMessage).to.equal("Success");
                    expect(mockResponse.send).to.be.calledWith(returnObj);
                });
        });
    });
